...
const renderHompage = function(req, res, responseBody){
  ...
  res.render('locations-list', {
    ...
    sidebar: "Looking for wifi and a seat? helps you findd places \
...
const homelist = (req, res) => {
  ...
  const requestOptions = {
    ...
    json: {},
    qs: {
      lng: 126.95967995304956,
      lat: 37.29589257964952,
      maxDistance: 200000
    }
  };
  request(
...
const showError = (req, res, status ) => {
  ...
  if(status === 404){
    ...
    content = 'Oh dear. Looks like you can\'t this page. Sorry.';
  } else{
    title = `${status}, something's gone wrong`;
    content = 'Something, somewhere, has gone just al ittle bit wrong.';
  }
  res.status(status);
